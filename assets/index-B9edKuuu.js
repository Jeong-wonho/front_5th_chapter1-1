...
`,p=()=>(console.log("Header component 랜더링"),`<header class="bg-blue-600 text-white p-4 sticky top-0">
    ...
    </header>`),b=()=>{const o="/front_5th_chapter1-1/",t=window.location.pathname.includes("hash.html")?"hash":"browser",s=()=>{if(t==="hash")return window.location.hash.slice(1)||"/";{const l=window.location.pathname;if(l.startsWith(o)){const i=l.substring(o.length)||"/";return i.startsWith("/")?i:`/${i}`}return l}};console.log("getCurrentPath",s());const n=localStorage.getItem("user"),r=s(),c=r==="/",P=r==="/profile",m=c?"text-blue-600 font-bold":"text-gray-600",F=P?"text-blue-600 font-bold":"text-gray-600",a=l=>{if(!l)return o;if(t==="hash")return`#${l}`;{if(l==="/")return o;const i=l.startsWith("/")?l.slice(1):l;return console.log("cleanPath",i),`${o.endsWith("/")?o.slice(0,-1):o}/${i}`}};console.log("getHref",a());let h;return n?h=`
