...
`},d={getUser(t){return JSON.parse(localStorage.getItem(t))},setUser(t,e){localStorage.setItem(t,JSON.stringify(e))},initUser(t){localStorage.removeItem(t)}},x=()=>{const t=d.getUser("user")||{username:"",email:"",bio:""};return`
  ...
  `},R=t=>{const e=document.getElementById("login-form");e&&(e.removeEventListener("submit",t),e.addEventListener("submit",t))},I=t=>{const e=document.getElementById("profile-form");e&&(e.removeEventListener("submit",t),e.addEventListener("submit",t))},C=t=>{const e=document.querySelector("nav");e&&(e.removeEventListener("click",t),e.addEventListener("click",t))},S=()=>`
  <main class="bg-gray-100 flex items-center justify-center min-h-screen">
